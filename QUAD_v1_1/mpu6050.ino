...
*/
  ...
  float RADIANS_TO_DEGREES = 57.2957795;//180/3.14159;
//  float accel_vector_length = sqrt(pow(accel_x,2) + pow(accel_y,2) + pow(accel_z,2));
  ...
  //TODO: set values to send, scale to fit in 16bit int
  dataTx[DataTxAngleX] = (angle_y * 91.0f);//5213.9159345); // 5213.9159345 for max resolution in signed 16bit int
  dataTx[DataTxAngleY] = (angle_x * 91.0f);//5213.9159345);
  //Serial.println(angle_x);
  //Serial.println(dataTx[DataTxAngleX]);
