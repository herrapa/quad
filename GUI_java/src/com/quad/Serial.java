 ...
 */
  public Serial(String iname, int irate,
    ...
    // On OS X, make sure the lock folder needed by RXTX is present
      //TODO: ?
    if (true) {//PApplet.platform == PConstants.MACOSX) {
      ...
      if (!lockFolder.exists() ||
        ...
        final String MESSAGE =
          "MacTalibaner: To use the serial library, first open\n" +
              ...
              if ((bufferUntil &&
                ...
                try {
                  //serialEventMethod.invoke(parent, new Object[] { this });
                    System.out.println("serialEventMethod.invoke(parent, new Object[] { this });");
                } catch (Exception e) {
